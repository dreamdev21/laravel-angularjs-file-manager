...
class Installer {
	 ...
	 * @var array
	 */
    private $dirs = array('/application', '/assets/avatars', '/application/storage', 
    	'/application/storage/app', '/application/storage/framework', '/application/storage/framework/views', 
    	'/application/storage/framework/cache', '/application/storage/framework/sessions', '/application/storage/yaml-translation', 
    	'/application/storage/logs', '/application/storage/uploads', '/application/storage/zips'
    );
